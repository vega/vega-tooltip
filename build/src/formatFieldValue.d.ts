 ...
 */
export declare function customFormat(value: ScenegraphPrimitive, formatType: string, format: string | FormatCallback): string | undefined;
/**
 * Automatically format a time, number or string value
 * @return the formatted time, number or string value
 */
export declare function autoFormat(value: ScenegraphPrimitive): string;
/**
