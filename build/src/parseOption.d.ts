import { FieldOption, Option, Scenegraph, ScenegraphData, SupplementedFieldOption, TooltipData } from './options';
/**
 * Prepare data for the tooltip
 * @return An array of tooltip data [{ title: ..., value: ...}]
 */
export declare function getTooltipData(item: Scenegraph, options: Option): TooltipData[];
/**
 ...
 */
export declare function prepareCustomFieldsData(itemData: ScenegraphData, options?: Option): TooltipData[];
/**
 ...
 */
export declare function getValue(itemData: ScenegraphData, field: string, isComposition: boolean): string | number | Date;
/**
 ...
 */
export declare function prepareAllFieldsData(itemData: ScenegraphData, options?: Option): TooltipData[];
/**
 ...
 */
export declare function removeFields(dataMap: ScenegraphData, removeKeys: string[]): void;
/**
 ...
 */
export declare function removeDuplicateTimeFields(itemData: ScenegraphData, optFields: SupplementedFieldOption[]): void;
/**
 ...
 */
export declare function combineBinFields(itemData: ScenegraphData, fieldOptions: FieldOption[]): ScenegraphData;
/**
 ...
 */
export declare function dropFieldsForLineArea(marktype: string, itemData: ScenegraphData): void;
