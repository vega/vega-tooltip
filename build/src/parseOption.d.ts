 ...
 */
export declare function prepareCustomFieldsData(itemData: object, options: Option): TooltipData[];
/**
 ...
 */
export declare function getValue(itemData: object, field: string): string | number | Date;
/**
 ...
 */
export declare function prepareAllFieldsData(itemData: object, options: Option): TooltipData[];
/**
 ...
 */
export declare function removeFields(dataMap: object, removeKeys: string[]): void;
/**
 ...
 */
export declare function removeDuplicateTimeFields(itemData: object, optFields: SupplementedFieldOption[]): any;
/**
 ...
 */
export declare function combineBinFields(itemData: object, fieldOptions: FieldOption[]): object;
/**
 ...
 */
export declare function dropFieldsForLineArea(marktype: string, itemData: object): void;
