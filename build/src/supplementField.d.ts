 ...
 */
export declare function getFieldOption(fieldOptions: FieldOption[], fieldDef: FieldDef<string>): FieldOption;
/**
 ...
 */
export declare function getFieldDef(fieldDefs: FieldDef<string>[], fieldOption: FieldOption): FieldDef<string>;
/**
 ...
 */
export declare function supplementFieldOption(fieldOption: FieldOption, fieldDef: FieldDef<string>, vlSpec: TopLevelExtendedSpec): SupplementedFieldOption;
