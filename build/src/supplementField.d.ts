...
import { NormalizedSpec, TopLevelSpec } from 'vega-lite/build/src/spec';
 ...
 * in options.fields
 */
export declare function supplementOptions(options: Option, vlSpec: TopLevelSpec): Option;
/**
 ...
 */
export declare function supplementFieldOption(fieldOption: FieldOption, fieldDef: FieldDef<any>, config: Config, vlSpec: NormalizedSpec): SupplementedFieldOption;
