...
describe('formatValue', () => {
  ...
  it('should handle objects', () => {
    ...
    expect(fv({a: 1})).toBe(
      '<table><tr><td class="key">a:</td><td class="value">1</td></tr></table>');

    expect(fv({a: [1, 2]})).toBe(
      '<table><tr><td class="key">a:</td><td class="value">[1,2]</td></tr></table>');

    expect(fv({a: {}})).toBe(
      '<table><tr><td class="key">a:</td><td class="value">{}</td></tr></table>');
    ...
    expect(fv(recursive)).toBe(
      '<table><tr>' +
      '<td class="key">foo:</td>' +
      '<td class="value">{"foo":"[Circular ~]"}</td>' +
      '</tr></table>');
